...
public class Vista {
	...
	public void inicialize() {
		frame = new JFrame();
		frame.setBounds(300, 300, 891, 499);
		...
		scrollPane_Original.setBounds(10, 10, 688, 426);
		...
		btnMostrarBiblioteca.setBounds(720, 65, 130, 28);
